      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-[#424245] pb-12 mb-8">
          ...
          <div className="space-y-6">
            <h3 className="text-[#f5f5f7] font-serif text-sm tracking-wide">Navigation</h3>
          ...
          {/* Column 3: Profiles */}
          <div className="space-y-6">
            <h3 className="text-[#f5f5f7] font-serif text-sm tracking-wide">Profiles</h3>
            <ul className="space-y-3">
              {footerLinks.profiles.map((item) => (
                <li key={item.name}>
                  <span className="hover:text-[#f5f5f7] transition-colors cursor-not-allowed opacity-70">
                    {item.name}
                  </span>
                </li>
              ))}
